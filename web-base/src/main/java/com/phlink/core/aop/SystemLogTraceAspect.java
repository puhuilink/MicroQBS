...
import com.phlink.core.common.utils.ObjectUtil;
import com.phlink.core.common.utils.ThreadPoolUtil;
import com.phlink.core.config.properties.PhlinkIpLimitProperties;
...
public class SystemLogTraceAspect {
    ...
    @Pointcut("@annotation(com.phlink.core.common.annotation.SystemLogTrace)")

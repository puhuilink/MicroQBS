...
import com.phlink.bus.api.system.dao.MenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public Map<String, Object> findMenus(Menu menu) {
        ...
        try {
            ...
            result.put("ids", ids);
            if (StringUtils.equals(menu.getType(), BusApiConstant.TYPE_BUTTON)) {
    ...
    public void updateMenu(Menu menu) throws Exception {
        ...
        // 查找与这些菜单/按钮关联的用户
        List<Long> userIds = this.baseMapper.findUserIdsByMenuId(menu.getMenuId());
    ...
    public void deleteMeuns(String[] menuIds) throws Exception {
        for (String menuId : menuIds) {
            ...
            // 查找与这些菜单/按钮关联的用户
            List<Long> userIds = this.baseMapper.findUserIdsByMenuId(menuIdL);
            // 递归删除这些菜单/按钮
            this.baseMapper.deleteMenus(menuIdL);
            // 重新将这些用户的角色和权限缓存到 Redis中
            this.userManager.loadUserPermissionRoleRedisCache(userIds);
        }
    }
